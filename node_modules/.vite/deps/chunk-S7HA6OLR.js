...
function useSsrResponse() {
  ...
  return {
    ...
    redirect: (location2, status = 302) => writeResponse({ headers: { location: location2 }, status })
  };
}
var externalRedirect = (location2) => {
...
function useClientRedirect(spaRedirect = externalRedirect) {
  return {
    ...
    redirect: (location2, status) => {
      return location2.startsWith("/") ? spaRedirect(location2) : externalRedirect(location2);
    }
  };
}
...
/*!
  ...
  * @license MIT
  */
//# sourceMappingURL=chunk-S7HA6OLR.js.map
