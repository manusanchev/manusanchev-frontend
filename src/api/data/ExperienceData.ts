...
export const experienceData: IExperienceSectionItem[] = [
  ...
  },
  {
    techName: "Vite",
    summary:
      "Alternativa a webpack con un módulo externo para SSR y vue con <span class='span-experience'>Typescript</span>",
    link: "https://vitejs.dev/",
  },
  {
    techName: "Laravel",
    summary: "Framework que más utilicé del ecosistema <span class='span-experience'>PHP</span>",
