<template>
  <section>
    <SectionHeader title="Contacto" subtitle="¿Empezamos a hablar?" />
    <ItemsListLayout class="gap-16 md:gap-20">
      <ContactItem v-for="(item, index) in contactData" :item="item" :key="index" />
    </ItemsListLayout>
  </section>
</template>
